...
The `tests/` directory contains automated validation scripts for SPF/DMARC policy enforcement:
...
### What the SPF/DMARC tests validate
...
See `tests/README.md` for detailed documentation on the complete test suite.
